...
const StaffEdit = () => {
  ...
  if (loading) {
    return <Loading fullScreen text="Loading staff data..." />;
  }

  if (!staff) {
    return (
      <div className="p-6 text-center">
        <h2 className="text-2xl font-semibold text-gray-900">Staff not found</h2>
  ...
  // Initial form values from staff data
  const initialValues = {
    name: staff.name || '',
